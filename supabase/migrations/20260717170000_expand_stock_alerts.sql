...
ALTER TABLE public.stock_alerts
  DROP CONSTRAINT IF EXISTS stock_alerts_variant_email_key;

CREATE UNIQUE INDEX IF NOT EXISTS stock_alerts_variant_email_unique
  ON public.stock_alerts (variant_id, email)
  WHERE variant_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS stock_alerts_product_email_unique
  ON public.stock_alerts (product_id, email)
  WHERE variant_id IS NULL;

CREATE INDEX IF NOT EXISTS stock_alerts_pending_lookup_idx
