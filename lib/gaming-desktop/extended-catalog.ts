...
type Row = readonly [brand: string, model: string, detail: string, meta?: Meta];
...
function fromRows(kind: PcPartKind, rows: readonly Row[]): PcPart[] {
  return rows.map(([brand, model, detail, meta]) =>
    makePart(kind, brand, model, detail, meta ?? {}),
  );
}
...
const cpuRows: readonly Row[] = [
  ...
  [
    ...
    "Ryzen 9 9950X3D",
    "16 cores · AM5 · DDR5",
    { socket: "AM5", memory: "DDR5", tdp: 170 },
  ],
  [
    "AMD",
    "Ryzen 9 9950X",
  ...
  [
    ...
    "Ryzen 9 9900X3D",
    "12 cores · AM5 · DDR5",
    { socket: "AM5", memory: "DDR5", tdp: 120 },
  ],
  [
    "AMD",
    "Ryzen 9 9900X",
  ...
  [
    ...
    "Ryzen 7 7700X",
    "8 cores · AM5 · DDR5",
    { socket: "AM5", memory: "DDR5", tdp: 105 },
  ],
  [
    "AMD",
    "Ryzen 7 7700",
  ...
  [
    ...
    "Ryzen 9 5950X",
    "16 cores · AM4 · DDR4",
    { socket: "AM4", memory: "DDR4", tdp: 105 },
  ],
  [
    "AMD",
    "Ryzen 9 5900X",
  ...
  [
    "Intel",
    "Core Ultra 9 285K",
    "24 cores · LGA1851 · DDR5",
    { socket: "LGA1851", memory: "DDR5", tdp: 125 },
  ],
  [
    "Intel",
    "Core Ultra 7 265K",
    "20 cores · LGA1851 · DDR5",
    { socket: "LGA1851", memory: "DDR5", tdp: 125 },
  ],
  [
    "Intel",
  ...
  [
    ...
    "Core i9-14900KS",
    "14th Gen · LGA1700",
    { socket: "LGA1700", memory: "DDR4 / DDR5", tdp: 150 },
  ],
  [
    "Intel",
    "Core i9-14900K",
    "14th Gen · LGA1700",
    { socket: "LGA1700", memory: "DDR4 / DDR5", tdp: 125 },
  ],
  [
    "Intel",
    "Core i9-14900KF",
  ...
  [
    ...
    "Core i5-12400F",
    "12th Gen · LGA1700",
    { socket: "LGA1700", memory: "DDR4 / DDR5", tdp: 65 },
  ],
  ...
  [
    "Intel",
    "Core i9-11900K",
    "11th Gen · LGA1200 · DDR4",
    { socket: "LGA1200", memory: "DDR4", tdp: 125 },
  ],
  [
    "Intel",
    "Core i9-11900KF",
  ...
  [
    ...
    "Core i7-11700",
    "11th Gen · LGA1200 · DDR4",
    { socket: "LGA1200", memory: "DDR4", tdp: 65 },
  ],
  [
    "Intel",
    "Core i5-11600K",
...
const motherboardRows: readonly Row[] = [
  ...
  [
    ...
    "MEG X870E GODLIKE",
    "AM5 · X870E · DDR5",
    { socket: "AM5", memory: "DDR5", formFactor: "E-ATX", maxMemoryGb: 256 },
  ],
  [
    "MSI",
...
const ramRows: readonly Row[] = [
  ...
  [
    "G.Skill",
    "Trident Z5 Royal 96GB DDR5-6400",
    "2×48GB · DDR5",
    { memory: "DDR5", capacityGb: 96 },
  ],
  [
    "G.Skill",
    "Trident Z5 RGB 64GB DDR5-6400",
    "2×32GB · DDR5",
    { memory: "DDR5", capacityGb: 64 },
  ],
  [
  ...
  [
    "G.Skill",
    "Ripjaws S5 32GB DDR5-6000",
    "2×16GB · DDR5",
    { memory: "DDR5", capacityGb: 32 },
  ],
  [
    "G.Skill",
    "Trident Z Neo 32GB DDR4-3600",
    "2×16GB · DDR4",
    { memory: "DDR4", capacityGb: 32 },
  ],
  [
    "G.Skill",
    "Ripjaws V 32GB DDR4-3600",
    "2×16GB · DDR4",
    { memory: "DDR4", capacityGb: 32 },
  ],
  [
    "G.Skill",
    "Ripjaws V 64GB DDR4-3200",
    "2×32GB · DDR4",
    { memory: "DDR4", capacityGb: 64 },
  ],
  ...
  [
    "Kingston",
    "FURY Beast RGB 32GB DDR5-6000",
    "2×16GB · DDR5",
    { memory: "DDR5", capacityGb: 32 },
  ],
  [
    "Kingston",
    "FURY Beast 32GB DDR5-5600",
    "2×16GB · DDR5",
    { memory: "DDR5", capacityGb: 32 },
  ],
  [
  ...
  [
    "Crucial",
    "Pro Overclocking 32GB DDR5-6000",
    "2×16GB · DDR5",
    { memory: "DDR5", capacityGb: 32 },
  ],
  [
  ...
  [
    "Crucial",
    "Ballistix MAX 32GB DDR4-4000",
    "2×16GB · DDR4",
    { memory: "DDR4", capacityGb: 32 },
  ],
  [
    "Crucial",
    "Ballistix 32GB DDR4-3600",
    "2×16GB · DDR4",
    { memory: "DDR4", capacityGb: 32 },
  ],
  ...
  [
    "ADATA",
    "XPG Lancer RGB 64GB DDR5-6000",
    "2×32GB · DDR5",
    { memory: "DDR5", capacityGb: 64 },
  ],
  [
    "ADATA",
    "XPG Lancer Blade 32GB DDR5-6000",
    "2×16GB · DDR5",
    { memory: "DDR5", capacityGb: 32 },
  ],
  [
    "ADATA",
    "XPG Spectrix D50 32GB DDR4-3600",
    "2×16GB · DDR4",
    { memory: "DDR4", capacityGb: 32 },
  ],
  ...
  [
    "Patriot",
    "Viper Venom RGB 64GB DDR5-6000",
    "2×32GB · DDR5",
    { memory: "DDR5", capacityGb: 64 },
  ],
  [
    "Patriot",
    "Viper Steel 32GB DDR4-3600",
    "2×16GB · DDR4",
    { memory: "DDR4", capacityGb: 32 },
  ],
  ...
  [
    "Lexar",
    "Ares RGB 64GB DDR5-6400",
    "2×32GB · DDR5",
    { memory: "DDR5", capacityGb: 64 },
  ],
  [
    "Lexar",
    "Ares RGB 32GB DDR5-6000",
    "2×16GB · DDR5",
    { memory: "DDR5", capacityGb: 32 },
  ],
];
...
const caseRows: readonly Row[] = [
  [
    ...
    "Dual chamber",
    {
      ...
      maxGpuLengthMm: 455,
      supportedRadiatorSizes: [120, 240, 280, 360, 420],
      supportedFanSizes: [120, 140],
    },
  ],
  [
    "Lian Li",
    ...
    "Panoramic",
    {
      ...
      maxGpuLengthMm: 408,
      supportedRadiatorSizes: [120, 240, 280, 360],
      supportedFanSizes: [120, 140],
    },
  ],
  [
  ...
  [
    ...
    "Legacy mid tower",
    {
      supportedFormFactors: ["ATX", "Micro-ATX", "Mini-ITX"],
      maxGpuLengthMm: 381,
      supportedRadiatorSizes: [120, 240, 280],
      supportedFanSizes: [120, 140],
    },
  ],
  ...
  [
    ...
    "Super tower",
    {
      supportedFormFactors: ["E-ATX", "ATX", "Micro-ATX", "Mini-ITX"],
      maxGpuLengthMm: 400,
      supportedRadiatorSizes: [120, 240, 280, 360, 420, 480],
      supportedFanSizes: [120, 140],
    },
  ],
  [
...
const fanRows: readonly Row[] = [
  [
    "Lian Li",
    "UNI FAN SL Wireless LCD 120 Triple Pack",
    "120mm",
    { fanSizeMm: 120 },
  ],
  ...
  [
    "Cooler Master",
    "MasterFan MF120 Halo Triple Pack",
    "120mm",
    { fanSizeMm: 120 },
  ],
...
export const extendedPcCatalog: Record<PcPartKind, PcPart[]> = {
  cpu: fromRows("cpu", cpuRows),

  gpu: fromRows("gpu", gpuRows),

  motherboard: fromRows("motherboard", motherboardRows),

  ram: fromRows("ram", ramRows),

  storage: fromRows("storage", storageRows),

  cooling: fromRows("cooling", coolingRows),

  psu: fromRows("psu", psuRows),

  case: fromRows("case", caseRows),

  fans: fromRows("fans", fanRows),
};
