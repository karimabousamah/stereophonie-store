...
function SparkIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 2.8c.5 4.8 2.9 7.2 7.7 7.7-4.8.5-7.2 2.9-7.7 7.7-.5-4.8-2.9-7.2-7.7-7.7 4.8-.5 7.2-2.9 7.7-7.7Z" />
      <path d="M19 16.5c.2 1.8 1.2 2.8 3 3-1.8.2-2.8 1.2-3 3-.2-1.8-1.2-2.8-3-3 1.8-.2 2.8-1.2 3-3Z" />
    </svg>
  );
}
