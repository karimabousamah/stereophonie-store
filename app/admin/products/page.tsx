  ...
  return (
    ...
    >
      <div className="px-5 py-8 sm:px-8 sm:py-10">
        ...
        <header className="rounded-[22px] border border-white/10 bg-white/[0.035] px-5 py-6 backdrop-blur-xl sm:px-7">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              ...
              className="group inline-flex items-center justify-center gap-3 rounded-full border border-white bg-white px-6 py-3.5 text-xs font-semibold uppercase tracking-[0.16em] text-black transition duration-300 hover:bg-transparent hover:text-white"
            >
          ...
          <div className="mt-6 flex items-center justify-between gap-5 rounded-[18px] border border-emerald-500/20 bg-[#effbf5] px-5 py-4 text-[#16815d]">
            <div>
              ...
              <p className="mt-1 text-xs text-[#16815d]/70">
                The product is saved in Draft products and remains hidden from customers.
              </p>
            </div>
        ...
        <section className="mt-6 overflow-hidden rounded-[22px] border border-white/10 bg-white/[0.025]">
          {!products?.length ? (
            <div className="flex min-h-[500px] flex-col items-center justify-center px-6 text-center">
              ...
              <Link
                href="/admin/products/new"
                className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/20 px-6 py-3.5 text-xs font-semibold uppercase tracking-[0.16em] transition hover:border-white hover:bg-white hover:text-black"
              >
